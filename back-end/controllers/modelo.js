...
controller.listar = function (req, res) {
   Modelo.find().populate('tipo').populate('marca').populate('combustivel').populate('cor').exec().then(
      // callback do bem
      function (marcas) {
...
controller.obterUm = function (req, res) {
   ...
   Modelo.findById(id).exec().then(
      //cllback do bem
      function (modelo) {//Zero ou um modelo
...
controller.atualizar = function (req, res) {
   ...
   Modelo.findByIdAndUpdate(id, req.body).exec().then(
      //Callback do bem
      function (modelo) {
         if (modelo) {
